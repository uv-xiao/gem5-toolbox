...
##  做 Simpoint 时需要改一下
TEST_ROUTE=/home/uvxiao/repos/sango/gem5/benchmarks/spec2017

##  这个对应的是测试 ELF 的地址
##  做 Simpoint 时需要改一下
SE_ELF_ROUTE=${TEST_ROUTE}/mcf_s.riscv

##  这个对应的是给 ELF 的输入文件的地址，Graph500 中还没用到输入文件，就先为空
##  做 Simpoint 时需要改一下
SE_INPUT_ROUTE=/home/uvxiao/repos/sango/gem5/benchmarks/spec2017/inp.in
